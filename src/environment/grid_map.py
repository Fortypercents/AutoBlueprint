...
class GridMap:
    ...
    def tick(self):
        ...
        for transport in reversed(self.transports):
            ...
            # --- 分支 A: 基础前向传输 ---
            if c_name in ("SystemABelt", "SystemAPipe",
            ...
            # --- 分支 B: 均匀分流器 ---
            elif c_name in ("SystemALogicRouter", "SystemAPipeRouter",
            ...
            # --- 分支 C: 溢流门 ---
            elif c_name in ("SystemAOverflowGate", "SystemAPipeOverflowGate"):
